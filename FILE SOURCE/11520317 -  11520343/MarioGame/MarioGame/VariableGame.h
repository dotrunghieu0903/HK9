...
#define VELOCITY_NORMAL							200		// ~3 pixel / frame
#define VELOCITY_FAST							500		// ~5 pixel / frame
#define VELOCITY_VERYFAST						1000		// ~8 pixel / frame

#define NORMAL_ANIMATION_RATE					150 // ms
#define RUN_ANIMATION_RATE						100 // ms
